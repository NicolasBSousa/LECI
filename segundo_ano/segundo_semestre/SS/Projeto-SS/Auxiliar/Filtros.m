...
N_taps = 64;           % Tamanho do filtro (128 amostras)
order = N_taps - 1;     % Ordem do filtro FIR (127)
BW = 50;               % Largura de banda (+/- 50 Hz)
...
%% Gráfico da resposta em frequencia
